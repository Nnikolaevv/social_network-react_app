...
const dialogsReducer = (state = initialState, action) => {
    switch (action.type) {
        case SEND_MSG:
            ...
            return {
                ...state,
                outcomeMessages: [...state.outcomeMessages, newMsg],
                newMsgText: "",
            }
...
export const updateMsgTextActionCreator = (inputMsg) => (
    {type: UPDATE_NEW_MSG_TEXT, newMsgText: inputMsg});
